...
weights sum to 1.0`}
      ...
      <Section title="Anti-cheat">
        <ul className="flex flex-col gap-3 text-[var(--color-ink-2)] leading-relaxed">
          <Bullet>
            <strong className="text-[var(--color-ink)]">Public taxonomy, private prompts.</strong>{" "}
            The categories and task types are open. The exact prompts rotate
            daily and are signed per-day.
          </Bullet>
          <Bullet>
            <strong className="text-[var(--color-ink)]">Server-side re-judgment.</strong>{" "}
            Every submission is re-graded centrally by a held-out judge model
            (Claude Haiku 4.5). The CLI&apos;s local score is provisional.
          </Bullet>
          <Bullet>
            <strong className="text-[var(--color-ink)]">Rate limits.</strong>{" "}
            Max 10 submissions per IP per day to prevent score-mining.
          </Bullet>
          <Bullet>
            <strong className="text-[var(--color-ink)]">Lab-verified flag.</strong>{" "}
            Lab-run results become the canonical record. Community submissions
            live for 30 days before rotating off the leaderboard.
          </Bullet>
        </ul>
      </Section>
    </div>
